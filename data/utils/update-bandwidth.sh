...
curl -v  -H "Content-Type: application/json" POST -d '{"server_name":"th-live-17.open-cdn.com","bandwidth_rx":"'$rx_value_recal'","bandwidth_tx":"'$tx_value_recal'"}' http://setlive.thailivestream.com/api/site/bandwidths/current
# {  
#    "id":"4",
